...
final class WeatherByNameRemoteDataSourceTest: XCTestCase {
    ...
    func testNameSearchedRemoteDataSource_whenWeatherRequestStatudCode200_completionReturnForecast() {
       //Given
    ...
    func testNameSearchedRemoteDataSource_whenStatusCode400_completionReturnError(){
            //Given
             let expectation = XCTestExpectation(description: "Gotten Forecast Data")
