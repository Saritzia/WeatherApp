...
final class MockWeatherRemoteDataSource : NameSarchedRemoteDataSourceProtocol {
    ...
    var forecastRemoteDataSourceModel : ForecastDataSourceModel = ForecastDataSourceModel(list: [List(dt: Date(timeIntervalSince1970: 1690902000), main: Main(temp: 37, temp_min: 32, temp_max: 37), weather: [Weather(id: 200, description: "cloud")])], city:City(name: "Madrid"))
